...
export const Auth = {
      ...
      <div class="auth-root">
        <div class="auth-card">
          <div style="text-align:center;margin-bottom:18px">
            ...
            <div style="font-size:12px;color:var(--text-muted);margin-top:8px">Your cart & wishlist travel with you — even if you change phone</div>
          </div>
          ...
          <form id="signinForm">
            ...
            <div class="auth-field"><label>Password</label><input type="password" name="password" required placeholder="••••••••" /></div>
          ...
          <form id="signupForm" style="display:none">
            ...
            <div class="auth-field"><label>Password * (min 6)</label><input type="password" name="password" required placeholder="••••••••" /></div>
            <button type="submit" class="auth-btn btn-primary" id="signupBtn">Create Account & Save to D1 →</button>
          </form>
  ...
  async afterRender(){
    ...
    signupForm?.addEventListener('submit', async(e)=>{
      ...
      finally{ btn.disabled=false; btn.textContent='Create Account & Save to D1 →'; }
    });
  }
};
